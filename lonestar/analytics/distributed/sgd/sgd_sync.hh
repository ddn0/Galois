...
//New vector type
GALOIS_SYNC_STRUCTURE_INDEX_REDUCE_SET(residual_latent_vector, NODE_DATA_RESIDUAL_LATENT_VECTOR, VecAtomicTy);
GALOIS_SYNC_STRUCTURE_INDEX_REDUCE_PAIR_WISE_ADD_ARRAY(residual_latent_vector, NODE_DATA_RESIDUAL_LATENT_VECTOR, VecAtomicTy);
...
//New vector type
GALOIS_SYNC_STRUCTURE_INDEX_REDUCE_SET(latent_vector, NODE_DATA_LATENT_VECTOR, VecTy);
GALOIS_SYNC_STRUCTURE_INDEX_REDUCE_PAIR_WISE_AVG_ARRAY(latent_vector, NODE_DATA_LATENT_VECTOR, VecTy);
